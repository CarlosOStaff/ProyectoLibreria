            ...
            <form action="{{route('user.update', $user->id)}}" method="POST">
                ...
                <div class="row mb-4">
                    <label for="horizontal-firstname-input" name="nombre" class="col-sm-3 col-form-label">First
                        name</label>
                    <div class="col-sm-9">
                        <input type="text" name="nombre" value="{{$user->nombre}}" class="form-control" id="horizontal-firstname-input"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="apellido" value="{{$user->apellido}}" class="form-control" id="horizontal-firstname-input"
                            placeholder="Enter Your ">
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                        <input type="email" value="{{$user->email}}" name="email" class="form-control" id="horizontal-email-input"
