    ...
    <form action="{{route('book.update',$item->id)}}" method="POST">
       ...
       @method('PUT')
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="titulo_libro" value="{{$item->titulo_libro}}">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="contenido" value="{{$item->contenido}}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-lg-4">
                    <div class="mb-3">
                        ...
                        <select id="formrow-inputState" name="etiqueta_id" class="form-select">
                            <option> {{$item->nombre_etiqueta}}</option>
