            ...
            <div class="">
                <form action="{{ url('/new-admin') }}" enctype="multipart/form-data" method="POST" id="frm"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <label for="img_perfil" class="col-form-label fst-italic fw-bold mt-3">Selecciona una
                                imagen de perfil</label>
                            <input class="form-control" id="img_perfil" required name="img_perfil" type="file"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div id="error_confirmar_password" style="color: red; display: none;">Las contraseñas no
                                coinciden.</div>
                        </div>
                    </div>
                    <div class="row mb-4">
...
@if (session('message_error_register'))
    <div class="alert alert-warning"><i class="fas fa-exclamation-triangle m-2"></i>{{session('message_error_register')}}
    </div>
@endif
...
<script>
    function previewImage() {
        ...
        if (file) {
            ...
            imgPreview.src = '/img/users/perfil/default_img.png'; // Vuelve a la imagen por defecto si no se selecciona ninguna
            imgPreview.style.display = 'block';
        }
    }
</script>
